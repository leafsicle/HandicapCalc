...
def app ()
  ...
  userName = check_name (user_stated_name)
    # ask if the user is uploading a file or entering text
  prompt_user_for_scores(userName)
  user_scoresget_scores
 

    # Score, slope, rating
  #  if they are uploading a file, open the explorer  and let them select the file
